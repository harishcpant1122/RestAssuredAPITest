...
#Given Add a place with "<request>" 
...
Then API call got success with status code 200
And "status" in response body is "OK"
When Verify the "address" field value as "<ResponseName>" when user calls the "GetPlaceAPI" for "<request>"

Examples:

|request 										| responseStatusCode |ResponseName           |
