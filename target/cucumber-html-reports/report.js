...
formatter.step({
  "name": "Verify the \"\u003cname\u003e\" when user calls the \"GetPlaceAPI\"",
  "keyword": "When "
});
formatter.examples({
  "name": "",
...
formatter.step({
  "name": "Verify the \"India\" when user calls the \"GetPlaceAPI\"",
  "keyword": "When "
});
formatter.match({
  "location": "apiStepdef.verify_the_when_user_calls_the(String,String)"
});
formatter.result({
  "status": "passed"
});
